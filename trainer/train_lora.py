...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_name", type=str, default="lora_medical_mix", help="LoRA权重名称(如lora_identity/lora_medical等)")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/lora_medical_mix.jsonl", help="LoRA训练数据路径")
    ...
    parser.add_argument("--debug_dataset_samples", default=0, type=int, help="打印前N条SFT样本的prompt和label调试信息")
    ...
    # ========== 6. 定义数据和优化器 ==========
    train_ds = SFTDataset(args.data_path, tokenizer, max_length=args.max_seq_len, debug_samples=args.debug_dataset_samples)
